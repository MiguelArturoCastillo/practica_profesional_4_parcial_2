                ...
                <main>
                    <div class="container-fluid px-4" >
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <section>
                            <div >
                                <div class="col-xl-3 col-md-5"style="align-content: center"><div>
                                        ...
                                        $obj_alumno=new alumno($ape,$nom,$fec,$tel,$es,$mo,$nom_cu,$mat);
                                        ...
                                        <br>
                                        <br>
                                        <a href="listado_alumno.php"class="btn btn-secondary">VOLVER</a>
                                    </div>
                            </div>
                        </div>
                    </div>                                                   
