...
/*echo "Cantidad de notas guardadas del segundo cuatrimestre es: ".$m;*/
 ...
 $cadena='insert into calificaciones(idcalificacion,idalumno,nota1_1,nota1_2,nota1_3,promedio_pri_cuatri_1,promedio_pri_cuatri_2) values (null,"'.$_REQUEST['txt_idalumno'].'","'.$_REQUEST['txt_calificacion1_1'].'","'.$_REQUEST['txt_calificacion1_2'].'","'.$_REQUEST['txt_calificacion1_3'].'","'.$prom_1.'","'.$prom_1_1.'")';
...
<br>
<a href="listado_alumno.php"class="btn btn-secondary" style="align-content: center" >VOLVER AL REGISTRO DE ALUMNOS</a>
