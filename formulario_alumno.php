                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">FORMULARO ALUMNO</h6>
                                        ...
                                        <div class="container text-center">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    Seleccione escuela <!--<input type="number" name="txt_escuela">-->
                                            ...
                                            <div class="col">
                                                    ...
                                                    <option  value="Secundaria tecnica">Secundaria tecnica</option>
                                                    </select>
                                                    </div>        
                                                <div class="col">
                                                    Seleccione materia
                                        ...
                                        <a href="listado_alumno.php" class="btn btn-secondary" style="align-content: center">VOLVER</a> 
                                        </div>                                         
                                        </form> 
