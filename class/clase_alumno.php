...
class alumno {
    ...
    public function listar()
    {
        ...
        while ($reg = $registros->fetch_array()) {
            ...
            echo '<td><a class="btn btn-secondary btn-sm" href="carga_calificacion.php?id='.$reg["idalumno"].'&alumno='.$reg['apellido'].'">ABRIR CALIFICACION 1 CUATRIMESTRE</td>';
            echo "</tr>";
            }
            echo "</table>";
    ...
    public function listar1()
    {
        ...
        while ($reg = $registros->fetch_array()) {
            ...
            echo "<td>".$reg['nombre_materia']."</td>";
            echo '<td><a class="btn btn-primary btn-sm" href="eliminar_alumno.php?id='.$reg["idalumno"].'">Eliminar</td>';
            echo '<td><a class="btn btn-secondary btn-sm" href="carga_calificacion1.php?id='.$reg["idalumno"].'&alumno='.$reg['apellido'].'">CALIFICACION</td>';
            echo "</tr>";
            }
            echo "</table>";
