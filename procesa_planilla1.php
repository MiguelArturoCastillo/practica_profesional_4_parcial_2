...
$es=$_REQUEST['lst_tete2'];
$mo=$_REQUEST['lst_tete3'];
$obj_planilla=new planilla("","","","","","","","","","","","","","","","","","","","","","","","","");
echo "ITEMS SELECCIONADOS: ";
echo "<BR>Curso seleccionado: ".$nom_cu;
echo "<br>Escuela seleccionada: ".$es;
echo "<br>";
echo "<br>Modalidad: ".$mo;
echo "<br>";
 
 
$obj_planilla->listar_planilla1($nom_cu,$es,$mo);
echo "<br>Resultados obtenidos de la busqueda";
?>
<BR>
<BR>
<a href="formulario_planilla1.php" class="btn btn-secondary" style="align-content: center" >VOLVER</a>
<BR>
<BR>
<hr>
<!--<a href="planilla_reporte.php" target="_blank" class="btn btn-secondary" style="align-content: center" >OBTENER PDF</a>-->
<BR>
<h6>DATOS SELECCIONADOS PARA GENEREAR REPORTE</h6>
<br>
<form action="planilla_reporte.php" method="POST"target="_blank" >
curso:<input type="text" name="txt_nom" readonly value="<?php echo $nom_cu;?>">
Escuela:<input type="text" name="txt_esc" readonly value="<?php echo $es;?>">
<br>
<br>    
<input type="submit" value="Generar reporte"class="btn btn-secondary" name="reporte"style="align-content: center" >
</form>
<BR>
</div>
                            </div>                                
