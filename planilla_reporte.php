...
$pdf->cell(30,10,'Apellido',0,0,'L',1);
//$pdf->cell(13,10,'Curso',0,0,'C',1);
//$pdf->cell(12,10,'Materia',0,0,'C',1);
$pdf->cell(10,10,'n1',0,0,'C',1);
$pdf->cell(10,10,'n2',0,0,'C',1);
$pdf->cell(10,10,'n3',0,0,'C',1);
$pdf->cell(10,10,'P.1',0,0,'C',1);
$pdf->cell(10,10,'Rec.1',0,0,'C',1);
$pdf->cell(10,10,'PF.1',0,0,'C',1);
$pdf->cell(10,10,'n1',0,0,'C',1);
$pdf->cell(10,10,'n2',0,0,'C',1);
$pdf->cell(10,10,'n3',0,0,'C',1);
$pdf->cell(10,10,'P.2',0,0,'C',1);
$pdf->cell(10,10,'Rec.2',0,0,'C',1);
$pdf->cell(10,10,'PF.1',0,1,'C',1);
...
while($row = $registros->fetch_assoc()){
    ...
    $pdf->cell(30,10,$row['nombre'],'B',0,'L',0);
    $pdf->cell(30,10,$row['apellido'],'B',0,'L',0);
    //$pdf->cell(13,10,$row['nombre_curso'],'B',0,'C',0);
    //$pdf->cell(12,10,$row['nombre_materia'],'B',0,'C',0);
    $pdf->cell(10,10,$row['nota1_1'],'B',0,'C',0);
    $pdf->cell(10,10,$row['nota1_2'],'B',0,'C',0);
    $pdf->cell(10,10,$row['nota1_3'],'B',0,'C',0);
    $pdf->cell(10,10,$row['promedio_pri_cuatri_1'],'B',0,'C',0);
    $pdf->cell(10,10,$row['recuperacion_1'],'B',0,'L',0);
    $pdf->cell(10,10,$row['promedio_pri_cuatri_2'],'B',0,'L',0);
    $pdf->cell(10,10,$row['nota2_1'],'B',0,'C',0);
    $pdf->cell(10,10,$row['nota2_2'],'B',0,'C',0);
    $pdf->cell(10,10,$row['nota2_3'],'B',0,'C',0);
    $pdf->cell(10,10,$row['promedio_seg_cuatri_1'],'B',0,'C',0);
    $pdf->cell(10,10,$row['recuperacion_2'],'B',0,'C',0);
    $pdf->cell(10,10,$row['promedio_seg_cuatri_2'],'B',1,'C',0);
}
